...
/**
 * \file    test/phpunit/ProductDefaultFunctionalTest.php
...
/**
 * Class ProductDefaultFunctionalTest
 *
 ...
 *
 * @package Testproductdefault
 */
class ProductDefaultFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modProductDefault')->click();
		} else {
			// Disable the module
			$this->byHref('modProductDefault')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/productdefault/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('productdefault/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/productdefault/admin/about.php');
		$this->authenticate();
		return $this->assertContains('productdefault/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('productdefaultwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modProductDefault_ProductDefaultTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modProductDefault_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
